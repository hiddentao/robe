...
class Collection {
  ...
  constructor (collection, options = {}) {
    ...
    this.findPromise = Q.promisify(this.collection.find, this.collection);
   ...
   * @param  {Any} [param] Parameter to pass to hook.
   */
  * _runHook (when, eventName, param) {
    var fn = compose(this._hooks[when][eventName]);

    yield fn.call(this, param);
  }
  ...
  * find (selector, options = {}) {
    return yield this.findPromise(selector);
  }
